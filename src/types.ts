...
export interface Photo { id: string; type: string; url: string; approved: booleranReview: Review; }
export interface Review { score: number; comments: string; approved: booleran }
